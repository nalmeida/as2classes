...
class as2classes.util.Alert extends MovieClip{
	
	public static var mcBg:MovieClip;
	public static var mcBox:MovieClip;
	public static var mcBt:MovieClip;
	...
	public static function show(str, tit){
