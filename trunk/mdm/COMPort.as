...
intrinsic class mdm.COMPort {
	...
	static function open(port:Number, baudRate:Number, dataBits:Number, parity:String, stopBits:Number, flowControl:String):Void;
	...
	static var rxBuffer:Number;
	static var txBuffer:Number;
}
