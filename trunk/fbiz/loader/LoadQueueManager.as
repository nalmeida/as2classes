...
class com.fbiz.loader.LoadQueueManager
{
	/*
	...
	*/
	...
	public function setPriority(int_priority:Number, obj_targetItem):Number
	{
		...
		// nicholas
		if(obj_tItem.target._target == currentLoadObject._target) return -4
	...
	private function startLoading():Void
	{
		...
		switch(int_targetLoadType)
		{
			...
			case 3:
				...
				__obj_mclListnr.onLoadError = function(target_mc:MovieClip, errorCode:String, httpStatus:Number)
				{
